...
| SSH/remote access in this refactor | 未执行 SSH 或任何真实远端读取；未执行 `sbatch/squeue/sacct` |
| remote staging | allowlisted fresh workspace、逐文件 SHA-256 与 POTCAR no-fetch 已通过 mock/fake E2E；真实站点待验证 |
