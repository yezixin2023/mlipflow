...
Their basenames and the exact source locations of each transcription are recorded in
...
- the exact top ten from an already-completed 247/247 large-supercell
  composition screening, with input and implementation paths;
- an auditable composition mapping from rank-1 `Mn6_Fe3_Ni8_Cu4_Zn7` to historical
  folder `6_3_8_4_7` and exact read-only transport post-processing parity; and
- claim-level unseen/transfer statements attributed to the main document.
