"""MLIPipe adapter for deterministic offline active-learning decisions."""
...
from mlipipe.plugins.active_learning import science as active_science

PLUGIN_ID = "active-learning"
RUNNER = Path(__file__).absolute().with_name(
    "active_learning.py"
)
...
MODEL_INDEX_CONTRACT = "mlipipe/active-learning-committee-model-index"
EVALUATION_DATASET_CONTRACT = "mlipipe/active-learning-evaluation-dataset"
REQUIRED_INPUTS = {
