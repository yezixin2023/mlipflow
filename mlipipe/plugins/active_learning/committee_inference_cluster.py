...
DATASET_CONTRACT = "mlipipe/active-learning-evaluation-dataset"
...
def _science_modules(input_dir: Path):
    runtime = _module("model_runtime", input_dir / "model_runtime.py")
    active = _module("active_learning_science", input_dir / "active_learning_science.py")
