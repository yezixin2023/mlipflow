"""MLIPipe lifecycle and strict result validation for benchmark artifacts.
...
BUNDLED_WRAPPER = (
    Path(__file__).absolute().with_name("benchmark_wrapper.py")
)
...
def _normalization_module():
    from . import benchmark_normalization
    return benchmark_normalization
