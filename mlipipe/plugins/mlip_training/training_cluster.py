...
def run(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        data_root = _site_root(args.data_root, "MLIPIPE_DATA_ROOT")
        ...
        if operation == "finetune":
            ...
            foundation_root_value = (
                ...
                or os.environ.get("MLIPIPE_FOUNDATION_MODEL_ROOT")
                or args.model_root
                or os.environ.get("MLIPIPE_MODEL_ROOT")
            )
            foundation_root = _site_root(
                foundation_root_value, "MLIPIPE_FOUNDATION_MODEL_ROOT"
            )
        ...
        if publish_id is not None or publish_relative is not None:
            ...
            model_root = _site_root(args.model_root, "MLIPIPE_MODEL_ROOT")
