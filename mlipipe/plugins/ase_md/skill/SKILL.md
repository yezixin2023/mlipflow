---
name: ase-md
description: Supervise scheduled ASE molecular dynamics with explicit DeepMD, M3GNet/MatGL, CHGNet, or MACE model artifacts. Use when planning, submitting, restarting, or verifying MLIP-driven NVT Langevin or isotropic MTK NPT trajectories on an MLIPipe ssh-slurm cluster profile.
---

# ASE molecular dynamics

Use `mlipipe/plugins/ase_md` through MLIPipe for the `run` operation. The Skill chooses and
