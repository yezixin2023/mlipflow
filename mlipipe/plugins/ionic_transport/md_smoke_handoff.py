...
def _load_md_source(path: Path) -> types.ModuleType:
    ...
    module = types.ModuleType("_mlipipe_historical_ase_md")
...
def run_handoff(
    *,
    ...
    source_artifacts = [
        ...
        _artifact(analysis_script, "mlipipe-transport-analysis-source"),
        _artifact(Path(__file__), "mlipipe-handoff-wrapper"),
    ]
